return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<Leader>dv", function() view.toggle() end, { desc = "Debug: Toggle View" })
    ...
    vim.keymap.set("n", "<Leader>dn", function() dap.step_over() end, { desc = "Debug: Step Over" })
    ...
    vim.keymap.set("n", "<Leader>dt", function() dap.terminate() end, { desc = "Debug:Session Terminate" })
  end,
}
